...
All tables use plain integer IDs.
"""
...
class Treatment(db.Model):
    ...
    active_ingredient = db.Column(db.String(300), nullable=True)
    notes           = db.Column(db.Text,   nullable=True)
    created_at      = db.Column(db.DateTime, default=datetime.utcnow)
...
class SymptomLog(db.Model):
    ...
    # ── Photo reference (stored privately by user, this is just a label) ──
    photo_reference = db.Column(db.String(300), nullable=True)
